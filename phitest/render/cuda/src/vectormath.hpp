...
/* Vector swizzle */
/*
inline __host__ __device__ float2 xx(const float1 v){ return make_float2(v.x, v.x);}
inline __host__ __device__ float2 xx(const float2 v){ return make_float2(v.x, v.x);}
inline __host__ __device__ float2 xx(const float3 v){ return make_float2(v.x, v.x);}
inline __host__ __device__ float2 xx(const float4 v){ return make_float2(v.x, v.x);}
*/
