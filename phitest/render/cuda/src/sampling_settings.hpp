...
struct SamplerSettings{
	...
	enum FilterMode{FILTERMODE_NEAREST=0, FILTERMODE_LINEAR=1, FILTERMODE_MIN=2, FILTERMODE_MAX=3, FILTERMODE_QUADRATIC=4} filterMode; //FILTERMODE_MIN FILTERMODE_MAX
	bool useTexture;
